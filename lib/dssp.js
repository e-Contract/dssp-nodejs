...
DSSP.prototype.handleSignResponse = function (req) {
    ...
    console.log("dssp session key: " + req.session.dsspKey);
    verify.keyInfoProvider = new SecurityTokenReferenceKeyInfoProvider(null, new Buffer(req.session.dsspKey, "base64"));
        ...
        "soap:Header": {
            "wsse:Security": {
                ...
                "wsu:Timestamp": {
                    ...
                    "wsu:Created": "2015-10-13T18:00:00Z",
                    "wsu:Expires": "2015-10-15T20:00:00Z"
                },
    ...
    postRequest.write(soapEnvelope);
    postRequest.end();
};
